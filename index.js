const INGENIEROS = [
  "ALEX BERROCAL GAMARRA",
  "ALEXANDRO DIEGO PRADA CASTILLO",
  "ANGEL RONALD HUAMANI VEGA",
  "ANTONY RUSBELT SAAVEDRA SACSARA",
  "JOHN MARIO HUAMANI CALLA",
  "JOSUE OSWALDO HUAMAN RODRIGUEZ",
  "KEVIN IVAN PALERMO URIBE",
  "LUIS JAIRO PALACIOS CLAVIJO",
  "MARLON TORRES SUAREZ",
  "MAURO DIAZ CASTILLON",
  "ROBERT AMADOR AGUIRRE",
  "ROBERT OTINIANO LOPEZ",
  "ROGERD FLORES BERNAL",
  "WILTON ARON MAZA SAYAGO",
  "WILLIAM ANDY RODRIGUEZ GAMBOA"
];
